...
export class UserController {
  ...
  static async getUsers(req: Request, res: Response): Promise<IResponse> {
    try {
  ...
  static async getUserById(req: Request, res: Response): Promise<IResponse> {
    try {
      const user = await UserRepo.getUserById(Number(req.params.userId))
